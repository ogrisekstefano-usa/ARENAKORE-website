...
DEFAULT_PAGES: Dict[str, List[Dict]] = {
    "homepage": [
        ...
        {"key": "how_s1_title",        "field_type": "heading", "translations": {"en": "NEXUS assigns your challenge", "it": "NEXUS assegna la tua sfida", "es": "NEXUS asigna tu desafío"}},
        {"key": "how_s1_desc",         "field_type": "text",    "translations": {"en": "Every day NEXUS assigns a challenge to your profile. No browsing. No selection. Execute.", "it": "Ogni giorno NEXUS assegna una sfida al tuo profilo. Zero navigazione. Zero scelta. Esegui.", "es": "Cada día NEXUS asigna un desafío a tu perfil. Sin búsqueda. Sin selección. Ejecuta."}},
    ...
    "arena-system": [
        ...
        {"key": "hero_sub",            "field_type": "text",    "translations": {"en": "NEXUS assigns. You execute. Your rank is the result.", "it": "NEXUS assegna. Tu esegui. Il tuo rank è il risultato.", "es": "NEXUS asigna. Tú ejecutas. Tu ranking es el resultado."}},
