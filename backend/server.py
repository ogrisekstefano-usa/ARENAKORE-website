...
DEFAULT_PAGES: Dict[str, List[Dict]] = {
    "homepage": [
        {"key": "hero_badge",          "field_type": "label",   "translations": {"en": "NEXUS LIVE · GLOBAL COMPETITION ACTIVE", "it": "NEXUS LIVE · COMPETIZIONE GLOBALE ATTIVA", "es": "NEXUS LIVE · COMPETICIÓN GLOBAL ACTIVA"}},
        ...
        {"key": "sport_selector_sub",  "field_type": "text",    "translations": {"en": "Choose your primary discipline", "it": "Scegli la tua disciplina principale", "es": "Elige tu disciplina principal"}},
        ...
        {"key": "how_badge",           "field_type": "label",   "translations": {"en": "HOW IT WORKS", "it": "COME FUNZIONA", "es": "CÓMO FUNCIONA"}},
        {"key": "how_h2",              "field_type": "heading", "translations": {"en": "4 STEPS. NO EXCUSES.", "it": "4 PASSI. ZERO SCUSE.", "es": "4 PASOS. CERO EXCUSAS."}},
        {"key": "how_s1_title",        "field_type": "heading", "translations": {"en": "Join a challenge", "it": "Entra in una sfida", "es": "Únete a un desafío"}},
        {"key": "how_s1_desc",         "field_type": "text",    "translations": {"en": "Pick any discipline, set your target. Challenge open or 1v1.", "it": "Scegli la disciplina, imposta l'obiettivo. Sfida aperta o 1vs1.", "es": "Elige la disciplina, fija tu objetivo. Desafío abierto o 1vs1."}},
        ...
        {"key": "how_s4_title",        "field_type": "heading", "translations": {"en": "Compete daily", "it": "Compete ogni giorno", "es": "Compite cada día"}},
        {"key": "how_s4_desc",         "field_type": "text",    "translations": {"en": "New challenges every day across every discipline.", "it": "Nuove sfide ogni giorno in ogni disciplina.", "es": "Nuevos desafíos cada día en cada disciplina."}},
        ...
        {"key": "d5_img",              "field_type": "image",   "translations": {"en": "https://images.unsplash.com/photo-1609408960307-ed11e7fb151f?crop=entropy&cs=srgb&fm=jpg&q=85&w=800", "it": "", "es": ""}},
        ...
        {"key": "d8_img",              "field_type": "image",   "translations": {"en": "https://images.unsplash.com/photo-1541534741688-7078a79f3f4e?crop=entropy&cs=srgb&fm=jpg&q=85&w=800", "it": "", "es": ""}},
    ...
    "for-athletes": [
        ...
        {"key": "hero_sub",            "field_type": "heading", "translations": {"en": "Enter the Arena.", "it": "Entra nell'Arena.", "es": "Entra en la Arena."}},
        ...
        {"key": "kore_challenges",     "field_type": "text",    "translations": {"en": "CHALLENGES — Daily. Direct. Permanent. Every challenge you accept becomes part of your record.", "it": "SFIDE — Quotidiane. Dirette. Permanenti. Ogni sfida che accetti diventa parte del tuo record.", "es": "DESAFÍOS — Diarios. Directos. Permanentes. Cada desafío que aceptas forma parte de tu historial."}},
        ...
        {"key": "nexus_body",          "field_type": "richtext","translations": {"en": "NEXUS doesn't watch you train. It judges you. Puppet Motion Detection tracks every joint, every angle, every rep. A rep that doesn't meet standard doesn't count. That's not punishment. That's truth.", "it": "NEXUS non ti guarda allenarti. Ti giudica. Il Puppet Motion Detection traccia ogni articolazione, ogni angolo, ogni rep. Una rep che non soddisfa lo standard non conta. Non è punizione. È verità.", "es": "NEXUS no te observa entrenar. Te juzga. El Puppet Motion Detection rastrea cada articulación, cada ángulo, cada rep. Una rep que no cumple el estándar no cuenta. No es castigo. Es verdad."}},
    ...
    "gym-pilot": [
        ...
        {"key": "hero_h1",             "field_type": "heading", "translations": {"en": "YOUR MEMBERS DON'T NEED MORE WORKOUTS. THEY NEED COMPETITION.", "it": "I TUOI ISCRITTI NON HANNO BISOGNO DI PIÙ ALLENAMENTI. HANNO BISOGNO DI COMPETIZIONE.", "es": "TUS MIEMBROS NO NECESITAN MÁS ENTRENAMIENTOS. NECESITAN COMPETICIÓN."}},
