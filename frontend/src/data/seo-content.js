...
export const PAGES = {
  fitnessApp: {
    ...
    howItWorks: [
      { step: '01', title: 'NEXUS activates your profile', desc: 'Create your KORE ID. NEXUS maps your athletic profile. The system takes over from here.' },
  ...
  amrap: {
    ...
    howItWorks: [
      { step: '01', title: 'NEXUS assigns your AMRAP', desc: 'NEXUS assigns movement, time cap, and difficulty. Your role: execute.' },
...
- Monthly challenge: NEXUS assigns the movement. Athletes execute. Results are public.
...
### 3. Autonomy (Choice)
Effective gamification preserves user agency. Fixed-difficulty challenges with no flexibility remove a critical psychological need. The most effective competition systems remove friction from execution. In ArenaKore, NEXUS assigns the challenge. Athletes execute. This removes decision fatigue and creates sustainable competitive engagement.
