...
export const FALLBACK_PAGES = {
  ...
  homepage: {
    ...
    hero_badge: 'NEXUS VALIDATION SYSTEM',
    hero_h1_line1: 'ENTER',
    hero_h1_line2: 'THE ARENA.',
    hero_sub: 'A performance validation system. NEXUS analyzes, selects and evaluates every challenge.',
    ...
    sport_selector_sub: 'Your discipline. NEXUS executes the rest.',
    ...
    solution_h2: 'NEXUS VALIDATES. ATHLETES PROVE.',
    ...
    how_badge: 'VALIDATION PROCESS',
    how_h2: 'NEXUS ANALYZES. SELECTS. EVALUATES.',
    how_s1_title: 'NEXUS analyzes',
    how_s1_desc: 'NEXUS scans performance data and maps the athletic profile.',
    how_s2_title: 'NEXUS selects',
    how_s2_desc: 'NEXUS creates and selects challenges designed by professional coaches and validated on thousands of athletes.',
    how_s3_title: 'You execute',
    how_s3_desc: 'NEXUS certifies every rep in real time. The result is the data.',
    how_s4_title: 'NEXUS evaluates',
    how_s4_desc: 'Your rank updates. A new challenge is assigned. The validation never stops.',
  ...
  'for-athletes': {
    ...
    hero_h1: "YOU DON'T CHOOSE. YOU'RE TESTED.",
  ...
  'arena-system': {
    ...
    hero_h1: 'NOT A PLATFORM. A SYSTEM.',
    hero_sub: 'A system designed to test and measure real performance.',
    hero_sub2: 'Any sport. Any discipline. One system.',
    not_fitness_app: 'This is not a fitness app. This is a performance validation system. NEXUS creates and selects challenges designed by professional coaches and validated on thousands of athletes.',
  ...
  'get-the-app': {
    ...
    hero_h1: 'DOWNLOAD. ENTER. EXECUTE.',
    hero_tension: 'NEXUS is waiting.',
    hero_sub1: 'Access the performance validation system.',
    hero_sub2: 'NEXUS assigns. You execute. Results are certified.',
    ...
    final_body: 'The system is live. NEXUS is ready to assign your first challenge. Every rep will be measured.',
