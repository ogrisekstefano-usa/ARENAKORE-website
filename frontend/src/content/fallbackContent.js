...
export const FALLBACK_PAGES = {
  ...
  homepage: {
    ...
    how_s1_title: 'NEXUS assigns your challenge',
    how_s1_desc: 'Every day NEXUS assigns a challenge to your profile. No browsing. No selection. Execute.',
  ...
  'arena-system': {
    ...
    not_fitness_app: 'This is not a fitness app. NEXUS runs the system. Athletes execute.',
